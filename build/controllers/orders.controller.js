...
exports.completedOrderController = exports.currentOrderController = void 0;
...
const currentOrderController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield ordersModel.currentOrder({ user_id: Number(req.query.user_id) });
        res.json({
            currentOrders: data
        });
    }
...
const completedOrderController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield ordersModel.completedOrder({ user_id: Number(req.query.user_id) });
        res.json({
