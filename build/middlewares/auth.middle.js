...
var authGuard = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, payload, user, error_1, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                token = token.split(" ")[1];
                payload = jsonwebtoken_1["default"].verify(token, auth_config_1["default"].jwtSecret);
                return [4 /*yield*/, usersTable.showByName(payload.sub)];
            case 1:
                user = _a.sent();
                if (!user)
                    throw new Error("Unauthorized");
